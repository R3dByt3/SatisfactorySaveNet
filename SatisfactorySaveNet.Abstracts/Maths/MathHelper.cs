...
namespace SatisfactorySaveNet.Abstracts.Maths
{
    ...
    public static class MathHelper
    {
        ...
        {
            return n < 0 ? throw new ArgumentOutOfRangeException(nameof(n), "Must be positive.") : MathF.Pow(2, MathF.Ceiling(MathF.Log(n, 2)));
        }
        ...
        {
            return n < 0 ? throw new ArgumentOutOfRangeException(nameof(n), "Must be positive.") : Math.Pow(2, Math.Ceiling(Math.Log(n, 2)));
        }
