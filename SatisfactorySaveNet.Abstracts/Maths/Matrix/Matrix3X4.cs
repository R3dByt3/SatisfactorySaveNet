...
#pragma warning restore S112 // General or reserved exceptions should never be thrown
        ...
        [Pure]
        public static Matrix4X3 Transpose(Matrix3X4 mat) => new(mat.Column0, mat.Column1, mat.Column2, mat.Column3);
...
#pragma warning restore S2328 // "GetHashCode" should not reference mutable fields
        ...
        [Pure]
        public override readonly bool Equals(object? obj) => obj is Matrix3X4 matrix && Equals(matrix);
        ...
        [Pure]
        public readonly bool Equals(Matrix3X4 other) => Row0 == other.Row0 &&
                Row1 == other.Row1 &&
                Row2 == other.Row2;
    }
}
