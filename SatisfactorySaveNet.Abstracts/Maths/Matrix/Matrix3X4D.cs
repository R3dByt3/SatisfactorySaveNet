...
namespace SatisfactorySaveNet.Abstracts.Maths.Matrix
{
    ...
    public struct Matrix3X4D : IEquatable<Matrix3X4D>, IFormattable
    {
        ...
        /// The zero matrix.
        /// </summary>
        public static readonly Matrix3X4D Zero = new(Vector4D.Zero, Vector4D.Zero, Vector4D.Zero);
        ...
        /// </summary>
        public readonly Vector3D Column3 => new(Row0.W, Row1.W, Row2.W);
        ...
        {
            Matrix3D inverseRotation = new(mat.Column0, mat.Column1, mat.Column2);
            ...
            Vector3D translation = new(mat.Row0.W, mat.Row1.W, mat.Row2.W);
