...
namespace SatisfactorySaveNet.Abstracts.Maths.Matrix
{
    ...
    public struct Matrix4X3 : IEquatable<Matrix4X3>, IFormattable
    {
        ...
        /// </summary>
        public readonly Vector4 Column0 => new(Row0.X, Row1.X, Row2.X, Row3.X);

        /// <summary>
        /// Gets the second column of this matrix.
        /// </summary>
        public readonly Vector4 Column1 => new(Row0.Y, Row1.Y, Row2.Y, Row3.Y);

        /// <summary>
        /// Gets the third column of this matrix.
        /// </summary>
        public readonly Vector4 Column2 => new(Row0.Z, Row1.Z, Row2.Z, Row3.Z);
...
#pragma warning restore S112 // General or reserved exceptions should never be thrown
        ...
        {
            Matrix3 inverseRotation = new(mat.Column0.Xyz, mat.Column1.Xyz, mat.Column2.Xyz);
        ...
        [Pure]
        public static Matrix3X4 Transpose(Matrix4X3 mat) => new(mat.Column0, mat.Column1, mat.Column2);
        ...
        /// <returns>A new Matrix4x3 which holds the result of the multiplication.</returns>
        [Pure]
        public static Matrix4X3 operator *(Matrix4X3 left, float right) => Mult(left, right);
...
#pragma warning restore S2328 // "GetHashCode" should not reference mutable fields
        ...
        [Pure]
        public override readonly bool Equals(object? obj) => obj is Matrix4X3 matrix && Equals(matrix);
        ...
        [Pure]
        public readonly bool Equals(Matrix4X3 other) => Row0 == other.Row0 &&
                Row1 == other.Row1 &&
                Row2 == other.Row2 &&
                Row3 == other.Row3;
    }
